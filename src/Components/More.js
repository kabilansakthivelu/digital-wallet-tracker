...
const More = () => {
    ...
    return (
        <div className="border-2 border-blue-500 rounded-xl md:mt-20 mx-4 p-4 shadow-2xl flex flex-col items-center mb-4">
            ...
            <Link to="/"><button className="mt-6 border-2 w-36 h-14 rounded-2xl border-blue-500 text-blue-500 font-bold hover:bg-blue-300 md:mt-10 hover:text-white xl:mt-8" onClick={signOut}>Sign Out</button></Link>
