...
const Update = () => {
    ...
    return (
        <div className="border-2 border-blue-500 bg-gray-300 rounded-xl md:mt-28 mx-4 p-4 shadow-2xl flex flex-col items-center pb-20">
            ...
            <select required name="transactionType" id="transactionType" className="border-gray-400 border-2 w-56 sm:w-96 md:w-11/12 h-11 pl-2 lg:mb-2" ref={refTransactionType}>
            <option value="">Please select</option>
            <option value="Credit">Credit</option>
            <option value="Debit">Dedit</option>
            </select><br/>
            <label htmlFor="description">Description* </label><br/>
            <input type="text" id="description" required className="border-gray-400 border-2 w-56 sm:w-96 md:w-11/12 text-lg h-11 pl-2 lg:mb-2" placeholder ="Describe your transaction" ref={refDescription}/><br/>
            <label htmlFor="amount">Amount in INR* </label><br/>
            <input type="number" id="amount" min="1" max="999999999" required className="border-gray-400 border-2 w-56 sm:w-96 md:w-11/12 text-lg h-11 pl-2 lg:mb-2" placeholder="Enter the amount" ref={refAmount}/>
            ...
            <h1 className="text-xl mt-6 mb-4 md:text-2xl">Updated wallet balance </h1>
